...
window.DOCS_PAGES = [
  ...
  },
  {
    ...
    pages: [
      ...
      { slug: "hub-registry", title: "hub/registry.js — base centrale", js: ["singleton module", "let _db = null", "fonctions exportées", "CHECK / FK SQLite", "box_tokens (token = événement)", "ON DELETE CASCADE", "token_clear (migration douce)"] },
      ...
      { slug: "hub-index", title: "hub/index.js — montage Express", js: ["express", "app.use", "chaîne de middleware", "ordre des routes", "error handler 4 args", "req / res / next", "trust proxy", "seed admin au démarrage"] },
      { slug: "hub-routes-auth", title: "hub/routes/auth.js", js: ["Router", "async / await", "try/catch + next", "argon2", "express-rate-limit"] },
      { slug: "hub-routes-events", title: "hub/routes/events.js", js: ["Set", "Map", "destructuring", "spread ...", "requireAdmin (création réservée)", "assignation propriétaire (lien d'enregistrement)"] },
      ...
      { slug: "hub-routes-admin", title: "hub/routes/admin.js", js: ["randomBytes", "récursion fichiers", "tokens de borne (par événement)"] },
  ...
  },
  {
    ...
    pages: [
      ...
      { slug: "borne-routes-sync", title: "borne/routes/sync.js", js: ["tâche de fond", "pull manuel (await + résultat)", "swap de token à chaud", "push-config (remontée config)"] },
      { slug: "borne-sync-hubclient", title: "borne/sync/hubClient.js", js: ["fetch natif", "backoff exponentiel", "Object.assign sur Error"] },
      { slug: "borne-sync-pull", title: "borne/sync/pull.js", js: ["vérif statut à l'application", "pullMyEvent (token = événement)", "404 comme cas normal", "pull one-shot au démarrage"] },
      { slug: "borne-sync-push", title: "borne/sync/push.js — séquence push", js: ["état module partagé", "for await", "FormData / Blob", "finally", "pushConfig (remontée config)"] },
    ],
  },
  {
    group: "5 — Le code front (web)",
    pages: [
      { slug: "web-client-hub", title: "hub/web client.js", js: ["fetch", "localStorage", "objet de méthodes", "getRole (décoder un JWT)", "atob / base64url"] },
