...
window.DOCS_PAGES = [
  ...
  },
  {
    ...
    pages: [
      ...
      { slug: "hub-registry", title: "hub/registry.js — base centrale", js: ["singleton module", "let _db = null", "fonctions exportées", "CHECK / FK SQLite", "box_tokens (token = événement)", "ON DELETE CASCADE"] },
  ...
  },
  {
    ...
    pages: [
      ...
      { slug: "borne-sync-pull", title: "borne/sync/pull.js", js: ["vérif statut à l'application", "pullMyEvent (token = événement)", "404 comme cas normal"] },
