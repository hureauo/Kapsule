...
window.DOCS_PAGES = [
  ...
  },
  {
    ...
    pages: [
      ...
      { slug: "core-eventdbschema", title: "core/eventDbSchema.js", js: ["better-sqlite3", "new Database", "pragma", "exec", "prepare / run / get / all", "transaction", "WAL", "event_users (roles JSON)"] },
