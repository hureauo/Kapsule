...
// Qualité/orientation vidéo (override local borne) a déménagé dans l'onglet
// Machine de la console /borne (PreflightPanel) — c'est un réglage borne, pas
// un réglage d'événement, et api.setVideoSettings est de toute façon
// tech-authentifié (§11.19) : il n'avait jamais vraiment sa place ici.
